  ...
  return (
    ...
    <div className="flex gap-6 p-6">
      ...
      <div className="w-2/3 border border-gray-300 rounded-lg p-6">
          ...
          <div key={index} className="flex items-start gap-4 border-b py-4">
            ...
            <div className="flex-1">
              ...
              <div className="mt-2 flex gap-2">
                <button className="px-4 py-1 text-sm border border-red-500 text-red-500 rounded hover:cursor-pointer hover:bg-red-400 hover:text-white">Remove</button>
                <button className="px-4 py-1 text-sm border border-gray-500 text-gray-500 rounded hover:cursor-pointer hover:text-blue-500">Save for later</button>
              </div>
            </div>
        ...
        <button className="mt-4 px-4 py-2 bg-blue-600 text-white rounded hover:cursor-pointer hover:bg-blue-500" onClick={() => window.location.href = '/smartphone'}>
          ← Back to shop
        </button>
      </div>
      ...
      <div className="w-1/3 border border-gray-300 rounded-lg p-6">
        <div className="mb-4">
          ...
          <div className="flex mt-2">
            ...
            <button className="bg-blue-500 text-white px-4 py-2 rounded-r hover:cursor-pointer hover:bg-blue-700">Apply</button>
          </div>
        </div>
        ...
        <div className="flex justify-center mt-4">
          <img src="/image/payment-all.png" alt="Payment Methods" className="w-80 hover:cursor-pointer" />
        </div>
      </div>
    </div>
    <SavedItems/>
